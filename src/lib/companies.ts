...
export const companies: Company[] = [
  {
    ...
    roadmap: [
      { quarter: 'Q4 2021', title: 'Initial lender network + 16 cities', status: 'shipped' },
      { quarter: 'Q2 2024', title: 'Scenario-based match + application triage', status: 'shipped' },
      { quarter: 'Q2 2026', title: 'Rate-band observatory with historic data', status: 'active' },
      { quarter: 'Q4 2026', title: 'Alberta expansion pilot', status: 'planned' },
    ],
  ...
  },
  {
    ...
    roadmap: [
      { quarter: 'Q3 2023', title: 'BC private clinic directory v1', status: 'shipped' },
      { quarter: 'Q4 2024', title: 'Cross-border procedure economics', status: 'shipped' },
  ...
  },
  {
    ...
    roadmap: [
      { quarter: 'Q2 2024', title: 'First 20 templates, 4 provinces', status: 'shipped' },
      { quarter: 'Q1 2025', title: 'All 10 provinces + employment bundle', status: 'shipped' },
      { quarter: 'Q2 2026', title: 'Interactive drafting flow', status: 'active' },
      { quarter: 'Q4 2026', title: 'Corporate-governance pack', status: 'planned' },
    ],
  ...
  },
  {
    ...
    roadmap: [
      { quarter: 'Q1 2022', title: 'First 300 suppliers, 100 categories', status: 'shipped' },
      { quarter: 'Q4 2024', title: '578+ suppliers, 165 categories, 12 regions', status: 'shipped' },
